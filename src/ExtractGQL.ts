...
export class ExtractGQL {
  ...
  /**
   *
   * Ensures no duplicate fragment names exist in a document.
   */
  public validateParsedDoc(doc: DocumentNode): void {
    const fragments = doc.definitions.filter((d) =>
